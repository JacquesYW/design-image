...
const Focus = (props: SvgIconProps) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={color || '#333'}
      ></path>
      <path d="M11.25 17H12.75V22H11.25V17Z" fill={color || '#333'}></path>
      <path d="M11.25 2H12.75V7H11.25V2Z" fill={color || '#333'}></path>
      <path d="M2.00098 11H7.00098V12.5H2.00098V11Z" fill={color || '#333'}></path>
      <path d="M17.001 11H22.001V12.5H17.001V11Z" fill={color || '#333'}></path>
    </svg>
  );
};
